...
ko:{
  ...
  mpFilterRegion:'국가(지역)', mpFilterCustomer:'고객사(사이트)', mpFilterProject:'설비명(프로젝트)', mpFilterNSelected:'개 선택',
...
en:{
  ...
  mpFilterRegion:'Country (Region)', mpFilterCustomer:'Customer (Site)', mpFilterProject:'Equipment (Project)', mpFilterNSelected:' selected',
...
zhHans:{
  ...
  mpFilterRegion:'国家(地区)', mpFilterCustomer:'客户(现场)', mpFilterProject:'设备名(项目)', mpFilterNSelected:'项已选',
...
zhHant:{
  ...
  mpFilterRegion:'國家(地區)', mpFilterCustomer:'客戶(現場)', mpFilterProject:'設備名(專案)', mpFilterNSelected:'項已選',
...
ja:{
  ...
  mpFilterRegion:'国(地域)', mpFilterCustomer:'顧客(サイト)', mpFilterProject:'設備名(プロジェクト)', mpFilterNSelected:'件選択中',
...
var STATUS_I18N={
  ko:{'진행중':'진행중','진행중(HQ)':'진행중(HQ)','진행중(Field)':'진행중(Field)','완료':'완료','발주 대기':'발주 대기','LOI 접수':'LOI 접수','예정':'예정'},
  en:{'진행중':'In Progress','진행중(HQ)':'In Progress (HQ)','진행중(Field)':'In Progress (Field)','완료':'Done','발주 대기':'Order Pending','LOI 접수':'LOI Received','예정':'Planned'},
  zhHans:{'진행중':'进行中','진행중(HQ)':'进行中(总部)','진행중(Field)':'进行中(现场)','완료':'完成','발주 대기':'待下单','LOI 접수':'已收到LOI','예정':'预定'},
  zhHant:{'진행중':'進行中','진행중(HQ)':'進行中(總部)','진행중(Field)':'進行中(現場)','완료':'完成','발주 대기':'待下單','LOI 접수':'已收到LOI','예정':'預定'},
  ja:{'진행중':'進行中','진행중(HQ)':'進行中(本社)','진행중(Field)':'進行中(現場)','완료':'完了','발주 대기':'発注待ち','LOI 접수':'LOI受領','예정':'予定'}
};
function tRegion(v){
  if(!v)return v;
