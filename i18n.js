...
ko:{
  ...
  tabHome:'🏠 홈', tabProjects:'🗂️ 프로젝트 관리', tabSetup:'🛠️ HQ 셋업 간트 차트', tabGantt:'📅 Field 셋업 간트 차트', tabPerson:'👤 인원 출장일', tabVision:'📊 월별 집계',
...
en:{
  ...
  tabHome:'🏠 Home', tabProjects:'🗂️ Projects', tabSetup:'🛠️ HQ Setup Gantt', tabGantt:'📅 Field Setup Gantt', tabPerson:'👤 Trip Days', tabVision:'📊 Monthly Summary',
...
zhHans:{
  ...
  tabHome:'🏠 首页', tabProjects:'🗂️ 项目管理', tabSetup:'🛠️ HQ安装甘特图', tabGantt:'📅 现场安装甘特图', tabPerson:'👤 人员出差日', tabVision:'📊 月度汇总',
...
zhHant:{
  ...
  tabHome:'🏠 首頁', tabProjects:'🗂️ 專案管理', tabSetup:'🛠️ HQ安裝甘特圖', tabGantt:'📅 現場安裝甘特圖', tabPerson:'👤 人員出差日', tabVision:'📊 月度彙總',
...
ja:{
  ...
  tabHome:'🏠 ホーム', tabProjects:'🗂️ プロジェクト管理', tabSetup:'🛠️ HQセットアップガント', tabGantt:'📅 現場セットアップガント', tabPerson:'👤 出張日数', tabVision:'📊 月別集計',
