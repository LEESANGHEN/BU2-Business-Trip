...
// ↓↓↓ BU2 전용 Google Sheets(Apps Script) 웹앱 URL로 교체하세요.
// 함께 전달한 Code.gs를 새 Google Sheet에 배포한 뒤 나오는 /exec URL을 여기에 붙여넣고 저장/배포하면
// 이 앱을 처음 여는 모든 사용자에게 자동으로 적용됩니다. (앱 안의 "⚙ Sheets 설정"에서 개별 브라우저마다
// 수동으로 넣어줘도 되지만, 팀 전체가 함께 쓰려면 이 줄을 바꿔서 배포하는 것을 권장합니다.)
var DEFAULT_SHEETS_URL='https://script.google.com/macros/s/AKfycbzajRyyNPrCbHju7cEDVSfmjoNzJgYSGpeQ1afaA019wBQX26zc4B-BR3aGmbgbvXPfmQ/exec';
