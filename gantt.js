...
function renderAll(){initTL();renderSidebar();renderHeader();renderGantt();if(_activeTab==='home')renderHomeTab();if(_activeTab==='projects')renderProjectsTab();if(_activeTab==='setup')renderSetupTab();if(_activeTab==='person')renderPersonTab();if(_activeTab==='equip')renderEquipTab();if(_activeTab==='vision')renderMonthlyAggTab();}
